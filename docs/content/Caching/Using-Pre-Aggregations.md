...
writing pre-aggregations before moving them to Cube Store.

> Get more info about default strategy

### Batching

Batching is a slightly more performant strategy where Cube.js sends compressed
CSVs for Cube Store to ingest.
...
When dealing with larger pre-aggregations (more than 500k rows), performance can
